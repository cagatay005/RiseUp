  ...
  return (
    <View>
      <Svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
        ...
        <SvgText x={center} y={35} fill={colors.textPrimary} fontSize={16} fontWeight="700" textAnchor="middle">N</SvgText>
        <SvgText x={center} y={size - 22} fill={colors.textSecondary} fontSize={13} textAnchor="middle">S</SvgText>
        <SvgText x={25} y={center + 5} fill={colors.textSecondary} fontSize={13} textAnchor="middle">W</SvgText>
        <SvgText x={size - 25} y={center + 5} fill={colors.textSecondary} fontSize={13} textAnchor="middle">E</SvgText>
